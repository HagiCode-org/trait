...
Trait scripts call the globally installed `hagi18n` binary directly. Do not use `npm exec hagi18n`; the npm package is scoped as `@hagicode/hagi18n`, and `npm exec hagi18n` resolves the wrong package name.
